...
data class Planet(@Description("The name of the planet.") val name: String)
...
/**
 * This is an example of how to use the OpenAI API with the Bedrock runtime. Requires the following
 ...
 */
suspend fun main() {
  val planet = BedrockModel.Anthropic.claude3<Planet>(prompt = "The planet Mars")
  println("planet: $planet")
  val essayStream =
    BedrockModel.Anthropic.claude3<Flow<String>>(
  ...
  val sentiment =
    BedrockModel.Anthropic.claude3<SentimentEvaluation>(
