...
public class Fact {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        try (PlatformConversation scope = OpenAI.conversation()) {
            var fact1 = scope.prompt(OpenAI.FromEnvironment.DEFAULT_SERIALIZATION, "A fascinating fact about you", FactRecord.class).get();
            var fact2 = scope.prompt(OpenAI.FromEnvironment.DEFAULT_SERIALIZATION, "An interesting fact about me", FactRecord.class).get();
