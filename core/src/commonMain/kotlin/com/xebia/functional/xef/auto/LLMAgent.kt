...
private fun AIScope.checkTotalLeftChatTokens(
...
private fun tokensFromMessages(
    messages: List<Message>,
    model: LLMModel
): Int =
    when (model) {
        ...
        LLMModel.GPT_3_5_TURBO_0301 ->
            model.modelType.encoding.countTokensFromMessages(messages, tokensPerMessage = 4, tokensPerName = 0)

        LLMModel.GPT_4_0314 ->
            model.modelType.encoding.countTokensFromMessages(messages, tokensPerMessage = 3, tokensPerName = 2)
...
private fun Encoding.countTokensFromMessages(
    ...
    messages.sumOf { message ->
        countTokens(message.role) + countTokens(message.content) + tokensPerMessage +
