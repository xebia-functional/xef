...
private fun Raise<AIError.Chain.Sequence.InvalidOutputs>.validateOutputKeys(outputKeys: Set<String>): Unit =
    ensure(outputKeys.size == 1) {
        AIError.Chain.Sequence.InvalidOutputs("The expected outputs are more than one: " +
