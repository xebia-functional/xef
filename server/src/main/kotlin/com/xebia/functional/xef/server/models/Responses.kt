...
@Serializable
data class OrganizationSimpleResponse(val id: Int, val name: String)
...
@Serializable
data class ProjectSimpleResponse(val id: Int, val name: String, val orgId: Int)
...
@Serializable
data class TokenSimpleResponse(val id: Int, val projectId: Int, val userId : Int, val name: String, val token: String)

fun XefTokens.toTokenSimpleResponse() = TokenSimpleResponse(id.value, projectId.value, userId.value, name, token)

@Serializable
data class TokenFullResponse(val id: Int, val project: ProjectSimpleResponse, val name: String, val token: String)

fun XefTokens.toTokenFullResponse(project: ProjectSimpleResponse) = TokenFullResponse(id.value, project, name, token)
