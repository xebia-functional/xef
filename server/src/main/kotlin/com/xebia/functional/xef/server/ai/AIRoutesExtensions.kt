...
suspend fun HttpClient.makeStreaming(call: ApplicationCall, url: String, body: ByteArray) {
...
fun ResponseHeaders.copyFrom(headers: Headers, vararg filterOut: String) =
  headers
    .entries()
    .filter { (key, _) ->
