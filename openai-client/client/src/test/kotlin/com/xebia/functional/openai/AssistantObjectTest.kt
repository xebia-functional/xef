...
class AssistantObjectTest : ShouldSpec() {
  init {
    ...
    // to test the property `createdAt` - The Unix timestamp (in seconds) for when the assistant was
    // created.
    ...
    // to test the property `model` - ID of the model to use. You can use the [List
    // models](/docs/api-reference/models/list) API to see all of your available models, or see our
