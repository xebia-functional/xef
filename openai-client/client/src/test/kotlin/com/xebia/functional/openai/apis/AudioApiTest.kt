...
class AudioApiTest : ShouldSpec() {
  init {
    ...
    should("test createTranscription") {
      ...
      // val file : java.io.File = BINARY_DATA_HERE // java.io.File | The audio file object (not
      // file name) to transcribe, in one of these formats: flac, mp3, mp4, mpeg, mpga, m4a, ogg,
      // wav, or webm.
      ...
      // or `vtt`.
      // val temperature : java.math.BigDecimal = 8.14 // java.math.BigDecimal | The sampling
      // temperature, between 0 and 1. Higher values like 0.8 will make the output more random,
      // while lower values like 0.2 will make it more focused and deterministic. If set to 0, the
      // model will use [log probability](https://en.wikipedia.org/wiki/Log_probability) to
    ...
    should("test createTranslation") {
      ...
      // val file : java.io.File = BINARY_DATA_HERE // java.io.File | The audio file object (not
      // file name) translate, in one of these formats: flac, mp3, mp4, mpeg, mpga, m4a, ogg, wav,
      // or webm.
      // val model : CreateTranscriptionRequestModel =  // CreateTranscriptionRequestModel |
      // val prompt : kotlin.String = prompt_example // kotlin.String | An optional text to guide
      // the model's style or continue a previous audio segment. The
