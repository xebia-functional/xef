...
class AudioApiTest : ShouldSpec() {
  init {
    ...
    should("test createSpeech") {
      ...
      // val result : com.xebia.functional.openai.infrastructure.OctetByteArray =
      // apiInstance.createSpeech(createSpeechRequest)
    ...
    should("test createTranscription") {
      ...
      // com.xebia.functional.openai.apis.UploadFile | The audio file object (not file name) to
      // transcribe, in one of these formats: flac, mp3, mp4, mpeg, mpga, m4a, ogg, wav, or webm.
    ...
    should("test createTranslation") {
      ...
      // val file : com.xebia.functional.openai.apis.UploadFile = BINARY_DATA_HERE //
      // com.xebia.functional.openai.apis.UploadFile | The audio file object (not file name)
      // translate, in one of these formats: flac, mp3, mp4, mpeg, mpga, m4a, ogg, wav, or webm.
      // val model : CreateTranscriptionRequestModel =  // CreateTranscriptionRequestModel |
      // val prompt : kotlin.String = prompt_example // kotlin.String | An optional text to guide
      // the model's style or continue a previous audio segment. The
