 ...
 *
 * @param b64Json The base64-encoded JSON of the generated image, if `response_format` is
 *   `b64_json`.
 * @param url The URL of the generated image, if `response_format` is `url` (default).
 * @param revisedPrompt The prompt that was used to generate the image, if there was any revision to
 *   the prompt.
 */
@Serializable
data class Image(
