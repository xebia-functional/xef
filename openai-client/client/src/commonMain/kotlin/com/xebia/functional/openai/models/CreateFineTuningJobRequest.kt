...
import com.xebia.functional.openai.models.CreateFineTuningJobRequestHyperparameters
...
data class CreateFineTuningJobRequest (
    ...
    @SerialName(value = "model") @Required val model: com.xebia.functional.openai.models.ext.finetune.job.create.CreateFineTuningJobRequestModel,
