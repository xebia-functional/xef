 ...
 * @return UploadFile
 */
suspend fun HttpClient.createSpeech(createSpeechRequest: CreateSpeechRequest): HttpResponse =
  request {
 ...
 *   [log probability](https://en.wikipedia.org/wiki/Log_probability) to automatically increase the
 *   temperature until certain thresholds are hit. (optional, default to 0)
 * @param timestampGranularities The timestamp granularities to populate for this transcription. Any
 *   of these options: &#x60;word&#x60;, or &#x60;segment&#x60;. Note: There is no additional
 ...
 */
suspend fun HttpClient.createTranscription(
  file: UploadFile,
  ...
  timestampGranularities: kotlin.collections.List<TimestampGranularitiesCreateTranscription>? = null
 ...
 *
 * @param file The audio file object (not file name) translate, in one of these formats: flac, mp3,
 ...
 */
suspend fun HttpClient.createTranslation(
  file: UploadFile,
  model: CreateTranscriptionRequestModel,
  prompt: kotlin.String? = null,
