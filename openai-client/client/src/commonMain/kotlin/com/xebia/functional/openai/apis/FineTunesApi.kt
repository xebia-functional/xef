...
open class FineTunesApi : ApiClient {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun createFineTune(createFineTuneRequest: CreateFineTuneRequest): HttpResponse<FineTune> {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun listFineTuneEvents(fineTuneId: kotlin.String, stream: kotlin.Boolean? = false): HttpResponse<ListFineTuneEventsResponse> {
