...
import com.xebia.functional.openai.models.RunObjectLastError
import com.xebia.functional.openai.models.RunObjectRequiredAction
...
data class RunObject (
    ...
    @SerialName(value = "tools") @Required val tools: kotlin.collections.List<AssistantObjectToolsInner> = arrayListOf(),
