 ...
 *
 * @param batchSize The batch size to use for training. The batch size is the number of training examples used to train a single forward and backward pass. 
 ...
 * @param classificationPositiveClass The positive class to use for computing classification metrics. 
 * @param computeClassificationMetrics The classification metrics to compute using the validation dataset at the end of every epoch. 
 */
@Serializable
...
data class FineTuneHyperparams (
    ...
    @SerialName(value = "learning_rate_multiplier") @Required val learningRateMultiplier: kotlin.Double,
    ...
    @SerialName(value = "compute_classification_metrics") val computeClassificationMetrics: kotlin.Boolean? = null
