...
open class FineTuningApi : ApiClient {
    ...
    open suspend fun cancelFineTuningJob(fineTuningJobId: kotlin.String): HttpResponse<FineTuningJob> {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.POST,
            "/fine_tuning/jobs/{fine_tuning_job_id}/cancel".replace("{" + "fine_tuning_job_id" + "}", "$fineTuningJobId"),
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun createFineTuningJob(createFineTuningJobRequest: CreateFineTuningJobRequest): HttpResponse<FineTuningJob> {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun listFineTuningEvents(fineTuningJobId: kotlin.String, after: kotlin.String? = null, limit: kotlin.Int? = 20): HttpResponse<ListFineTuningJobEventsResponse> {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.GET,
            "/fine_tuning/jobs/{fine_tuning_job_id}/events".replace("{" + "fine_tuning_job_id" + "}", "$fineTuningJobId"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
        )
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun listPaginatedFineTuningJobs(after: kotlin.String? = null, limit: kotlin.Int? = 20): HttpResponse<ListPaginatedFineTuningJobsResponse> {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun retrieveFineTuningJob(fineTuningJobId: kotlin.String): HttpResponse<FineTuningJob> {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.GET,
            "/fine_tuning/jobs/{fine_tuning_job_id}".replace("{" + "fine_tuning_job_id" + "}", "$fineTuningJobId"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
        )
