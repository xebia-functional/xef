 ...
 * @param maxTokens The maximum number of [tokens](/tokenizer) to generate in the completion.  The token count of your prompt plus `max_tokens` cannot exceed the model's context length. [Example Python code](https://cookbook.openai.com/examples/how_to_count_tokens_with_tiktoken) for counting tokens. 
...
data class CreateCompletionRequest (
    ...
    @SerialName(value = "model") @Required val model: com.xebia.functional.openai.models.ext.completion.create.CreateCompletionRequestModel,

    @SerialName(value = "prompt") @Required val prompt: com.xebia.functional.openai.models.ext.completion.create.CreateCompletionRequestPrompt?,
    ...
    @SerialName(value = "stop") val stop: com.xebia.functional.openai.models.ext.completion.create.CreateCompletionRequestStop? = null,
