...
data class CreateCompletionRequest(
  ...
  @Contextual @SerialName(value = "best_of") val bestOf: kotlin.Int? = 1,
  /* Echo back the prompt in addition to the completion  */
  @Contextual @SerialName(value = "echo") val echo: kotlin.Boolean? = false,
  ...
  @Contextual @SerialName(value = "logprobs") val logprobs: kotlin.Int? = null,
  ...
  @Contextual @SerialName(value = "max_tokens") val maxTokens: kotlin.Int? = 16,
  ...
  @Contextual @SerialName(value = "stop") val stop: CreateCompletionRequestStop? = null,
