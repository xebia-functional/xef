 ...
 */
suspend fun HttpClient.createImage(createImageRequest: CreateImageRequest): ImagesResponse =
  request {
 ...
 * @param mask An additional image whose fully transparent areas (e.g. where alpha is zero) indicate
 *   where &#x60;image&#x60; should be edited. Must be a valid PNG file, less than 4MB, and have the
 *   same dimensions as &#x60;image&#x60;. (optional)
 ...
 *   detect abuse. [Learn more](/docs/guides/safety-best-practices/end-user-ids). (optional)
 * @return ImagesResponse
 */
suspend fun HttpClient.createImageEdit(
  image: UploadFile,
 ...
 * @return ImagesResponse
 */
suspend fun HttpClient.createImageVariation(
  image: UploadFile,
  model: CreateImageEditRequestModel? = null,
  n: kotlin.Int? = 1,
