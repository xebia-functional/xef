...
sealed interface CreateChatCompletionRequestModel {
  ...
  enum class Standard(override val value: String) : CreateChatCompletionRequestModel {
    ...
    `gpt_4`("gpt-4"),
    @SerialName(value = "gpt-4-0314")
    `gpt_4_0314`("gpt-4-0314"),
    @SerialName(value = "gpt-4-0613")
    `gpt_4_0613`("gpt-4-0613"),
    @SerialName(value = "gpt-4-32k")
    `gpt_4_32k`("gpt-4-32k"),
    @SerialName(value = "gpt-4-32k-0314")
    `gpt_4_32k_0314`("gpt-4-32k-0314"),
    @SerialName(value = "gpt-4-32k-0613")
    `gpt_4_32k_0613`("gpt-4-32k-0613"),
    @SerialName(value = "gpt-3.5-turbo-1106")
    `gpt_3_5_turbo_1106`("gpt-3.5-turbo-1106"),
    @SerialName(value = "gpt-3.5-turbo")
    `gpt_3_5_turbo`("gpt-3.5-turbo"),
    @SerialName(value = "gpt-3.5-turbo-16k")
