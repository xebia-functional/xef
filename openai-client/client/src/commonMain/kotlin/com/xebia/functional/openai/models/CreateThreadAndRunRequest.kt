...
import com.xebia.functional.openai.models.CreateThreadAndRunRequestToolsInner
 ...
 * @param thread 
 * @param model The ID of the [Model](/docs/api-reference/models) to be used to execute this run. If a value is provided here, it will override the model associated with the assistant. If not, the model associated with the assistant will be used.
...
data class CreateThreadAndRunRequest (
    ...
    @SerialName(value = "tools") val tools: kotlin.collections.List<CreateThreadAndRunRequestToolsInner>? = null,
