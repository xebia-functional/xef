...
import com.xebia.functional.openai.models.ChatCompletionFunctions
import com.xebia.functional.openai.models.ChatCompletionTool
import com.xebia.functional.openai.models.ChatCompletionToolChoiceOption
import com.xebia.functional.openai.models.CreateChatCompletionRequestFunctionCall
import com.xebia.functional.openai.models.CreateChatCompletionRequestResponseFormat
 ...
 * @param model 
 * @param frequencyPenalty Number between -2.0 and 2.0. Positive values penalize new tokens based on their existing frequency in the text so far, decreasing the model's likelihood to repeat the same line verbatim.  [See more information about frequency and presence penalties.](/docs/guides/gpt/parameter-details) 
 ...
 * @param maxTokens The maximum number of [tokens](/tokenizer) to generate in the chat completion.  The total length of input tokens and generated tokens is limited by the model's context length. [Example Python code](https://cookbook.openai.com/examples/how_to_count_tokens_with_tiktoken) for counting tokens. 
 * @param n How many chat completion choices to generate for each input message.
 * @param presencePenalty Number between -2.0 and 2.0. Positive values penalize new tokens based on whether they appear in the text so far, increasing the model's likelihood to talk about new topics.  [See more information about frequency and presence penalties.](/docs/guides/gpt/parameter-details) 
...
data class CreateChatCompletionRequest (
    ...
    @SerialName(value = "messages") @Required val messages: kotlin.collections.List<com.xebia.functional.openai.models.ext.chat.ChatCompletionRequestMessage>,

    @SerialName(value = "model") @Required val model: com.xebia.functional.openai.models.ext.chat.create.CreateChatCompletionRequestModel,
    ...
    @SerialName(value = "logit_bias") val logitBias: kotlin.collections.Map<kotlin.String, kotlin.Int>? = null,
    ...
    @SerialName(value = "stop") val stop: com.xebia.functional.openai.models.ext.chat.create.CreateChatCompletionRequestStop? = null,
    ...
    @Deprecated(message = "This property is deprecated.")
    @SerialName(value = "functions") val functions: kotlin.collections.List<ChatCompletionFunctions>? = null
