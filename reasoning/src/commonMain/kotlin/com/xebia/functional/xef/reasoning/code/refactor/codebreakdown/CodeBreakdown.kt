...
class CodeBreakdown(
  ...
  suspend fun breakDownCode(code: String): CodeBreakdownResult {
    ...
    return callModel<CodeBreakdownResult>(
      ...
      scope,
      ExpertSystem(
        system = "You are an expert in code breakdown that can break down complex long functions or classes into smaller functions that are more readable and have better semantics",
        query = """|
      ...
      logger.info { "🔍 Code breakdown result: $it" }
    }
  }
}
