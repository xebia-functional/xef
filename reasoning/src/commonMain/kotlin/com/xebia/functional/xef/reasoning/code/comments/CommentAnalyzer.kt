...
class CommentAnalyzer(
  ...
  suspend fun analyzeComments(sourceCode: String): CommentAnalysisResult {
    ...
    return callModel<CommentAnalysisResult>(
      ...
      scope,
      ExpertSystem(
        system = "You are an expert in code comment analysis that can analyze comments and provide feedback on their quality, completeness, and usefulness",
        query = """|
      ...
      logger.info { "🔍 Comment analysis result: $it" }
    }
  }
}
