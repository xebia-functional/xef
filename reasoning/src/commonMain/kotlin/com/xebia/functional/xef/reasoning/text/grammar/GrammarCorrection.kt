...
class GrammarCorrection(
  ...
  suspend fun correctGrammar(text: String): GrammarCorrectionResult {
    ...
    return callModel<GrammarCorrectionResult>(
      ...
      scope,
      prompt = ExpertSystem(
        system = "You are an expert in grammar correction that can fix any grammatically unsound text and turn it into grammatically and sensically correct text",
        query = """|
      ...
      logger.info { "🔍 Grammar correction result: $it" }
    }
  }
}
